  ...
  return (
    ...
    >
          ...
          <div className="absolute top-3 left-3">
            <span className={`text-[10px] font-semibold uppercase tracking-[0.08em] px-3 py-1.5 rounded-full backdrop-blur-md border ${
              product.badge === "Bästsäljare"
                ? "bg-[#81D8D0]/90 text-white border-[#81D8D0]"
                : product.badge === "Nyhet"
      ...
      <div className="p-4 md:p-5">
        <span className="font-mono text-[9px] uppercase tracking-[0.12em] text-[#81D8D0] mb-1 block">
          {product.category}
        </span>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[var(--border-default)] bg-[var(--bg-card)] mb-6">
            <ShoppingBag className="w-3 h-3 text-[#81D8D0]" />
        ...
        <div className="relative">
          ...
          >
            ...
            <motion.div
              ...
              className="relative z-10 text-center max-w-lg px-10 py-12 rounded-3xl bg-white/80 backdrop-blur-xl border border-[#81D8D0]/20 shadow-[0_8px_60px_rgba(129,216,208,0.12)]"
            >
              {/* Animated glow ring around lock */}
              <div className="relative w-20 h-20 mx-auto mb-8">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#81D8D0] to-[#6BC5BD] animate-pulse opacity-20" />
                <div className="relative w-full h-full rounded-2xl bg-gradient-to-br from-[#81D8D0] to-[#6BC5BD] flex items-center justify-center shadow-[0_4px_20px_rgba(129,216,208,0.3)]">
              ...
              <a
                href="#request"
                className="group inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#81D8D0] text-white text-sm font-semibold hover:bg-[#6BC5BD] hover:shadow-[0_4px_24px_rgba(129,216,208,0.3)] transition-all duration-300"
              >
