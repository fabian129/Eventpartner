    ...
    <section id="venues" className="relative w-full bg-[var(--bg-primary)] px-6 md:px-10 py-20 md:py-32">
      <div className="max-w-[1200px] mx-auto">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 z-10">
                <div className="flex items-end justify-between gap-4">
                  <div>
                    <p className="font-mono text-[9px] uppercase tracking-[0.15em] text-tiffany mb-1.5">{venue.type}</p>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.6 }} className="mt-8 text-center">
          <a href="#request" className="inline-flex items-center gap-2 px-6 py-2.5 text-[13px] text-[var(--text-muted)] bg-[var(--bg-card)] border border-[var(--border-default)] rounded-full transition-all duration-300 hover:border-tiffany/30 hover:text-tiffany">
