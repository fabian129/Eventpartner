...
export function FullbleedImageBreak() {
  return (
    <section className="relative w-full bg-[#0A0A0A] overflow-hidden">
      ...
      {/* Subtle ambient glow */}
      <div className="absolute top-1/2 right-0 w-[60%] h-[80%] -translate-y-1/2 bg-tiffany/[0.03] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="flex flex-col justify-center px-8 md:px-16 lg:px-20 py-20 md:py-28">
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              <div className="w-1.5 h-1.5 rounded-full bg-tiffany shadow-[0_0_8px_rgba(129,216,208,0.5)]" />
            ...
            >
              <a
                href="#about"
                className="group inline-flex items-center gap-3 text-[14px] font-medium text-white/50 hover:text-tiffany transition-colors duration-300"
              >
                <span className="h-[1px] w-8 bg-white/20 group-hover:w-12 group-hover:bg-tiffany transition-all duration-300" />
                Läs mer om oss
        ...
        <div className="relative hidden lg:block">
          ...
          >
            <div className="px-6 py-4 rounded-xl bg-white/[0.06] backdrop-blur-xl border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-2 h-2 rounded-full bg-tiffany shadow-[0_0_6px_rgba(129,216,208,0.5)] animate-pulse" />
          ...
          >
            <div className="px-4 py-2.5 rounded-lg bg-white/[0.04] backdrop-blur-md border border-white/[0.06]">
              <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-tiffany/60">
                Featured Case
              </span>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-tiffany/20 to-transparent" />
    </section>
  );
}
