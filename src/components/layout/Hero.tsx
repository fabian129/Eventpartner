...
export function Hero() {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-white">
      {/* Text */}
      <div className="relative z-30 w-full max-w-[900px] mx-auto px-6 md:px-10 pt-28 md:pt-36 text-center">
        <motion.div
      ...
      {/* Globe with CSS-anchored labels */}
      <div className="relative z-10 w-full flex justify-center mt-6 md:mt-4">
        <div className="relative globe-container" style={{ width: "min(650px, 90vw)", height: "min(650px, 90vw)" }}>
          {/* Labels — positioned via Cobe CSS anchor variables */}
          {LABELS.map((label) => (
            <div
              key={label.id}
          ...
          {/* Orbital ring with text — Cobe V2 style */}
          <div
      ...
      {/* Top fade — masks orbital ring under buttons */}
      <div className="absolute top-0 left-0 right-0 h-[420px] z-20 pointer-events-none" style={{ background: "linear-gradient(to bottom, var(--bg-primary) 60%, transparent)" }} />
