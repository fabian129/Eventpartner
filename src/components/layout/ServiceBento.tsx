...
function BentoCard({ service, index }: { service: typeof SERVICES[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#81D8D0] text-[#0a0a0a] text-[10px] font-semibold uppercase tracking-[0.1em] px-4 py-2 rounded-full whitespace-nowrap shadow-lg shadow-[#81D8D0]/20">
          Boka nu →
        </div>
      </div>
