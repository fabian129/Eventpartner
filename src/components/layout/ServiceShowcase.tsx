      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        >
          <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-[var(--text-primary)] leading-[1.05]">
            Allt ni behöver.<br />
            <span className="italic text-tiffany" style={{ fontFamily: "var(--font-serif), 'Playfair Display', serif" }}>En partner.</span>
          </h2>

          <div className="flex flex-col items-start md:items-end gap-3 shrink-0">
            <div className="flex items-center gap-1.5 text-tiffany">
              {[...Array(5)].map((_, i) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 md:gap-8">
            ...
            >
              {/* Ambient glow */}
              <div className="absolute -left-16 -bottom-16 w-64 h-64 rounded-full bg-tiffany/15 blur-[80px] pointer-events-none" />
                ...
                <div className="w-full sm:w-2/3 flex flex-col relative z-10 justify-center pl-0 sm:pl-0">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <span className="text-sm font-light text-white/90">340,000+ kurerade venues</span>
                    </div>
                    <div className="flex items-center gap-3.5">
        ...
        >
          <Link
            href="#request"
            className="group flex items-center justify-between p-5 md:p-6 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-default)] hover:border-tiffany/20 transition-all duration-300"
          >
            <div>
