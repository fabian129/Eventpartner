...
export const EUROPE: Country[] = [
  ...
  },
  {
    ...
    topVenues: [
      ...
      { name: "Rogner Hotel Europapark Conference Centre", city: "Tirana", capacity: "800", type: "Hotel & Conference" },
      { name: "Tirana East Gate Conference Center", city: "Tirana", capacity: "1 200", type: "Convention center" },
      { name: "Maritim Hotel Plaza Tirana Conference Hall", city: "Tirana", capacity: "600", type: "Hotel & Conference" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Sport Hotel Hermitage & Spa Conference Hall", city: "Soldeu", capacity: "400", type: "Hotel & Conference" },
      { name: "Hotel Princesa Parc Conference Centre", city: "Arinsal", capacity: "350", type: "Hotel & Conference" },
      { name: "Caldea Thermal Spa & Convention Centre", city: "Escaldes-Engordany", capacity: "300", type: "Convention center" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Plovdiv International Fair", city: "Plovdiv", capacity: "10 000+", type: "Exhibition center" },
      { name: "Sofia Event Center", city: "Sofia", capacity: "3 000", type: "Event Venue" },
      { name: "Paradise Center Conference Hall", city: "Sofia", capacity: "1 200", type: "Conference center" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Odense Congress Center", city: "Odense", capacity: "2 500", type: "Convention center" },
      { name: "Aalborg Congress & Culture Centre", city: "Aalborg", capacity: "2 000", type: "Convention center" },
      { name: "Copenhagen Marriott Conference Centre", city: "Copenhagen", capacity: "1 500", type: "Hotel & Conference" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Tampere Exhibition and Sports Centre", city: "Tampere", capacity: "8 000", type: "Convention center" },
      { name: "Turku Fair & Congress Centre", city: "Turku", capacity: "5 000", type: "Convention center" },
      { name: "Oulu Music Centre Conference Hall", city: "Oulu", capacity: "1 500", type: "Convention center" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Messe Berlin – CityCube", city: "Berlin", capacity: "11 000", type: "Convention center" },
      { name: "Congress Center Hamburg (CCH)", city: "Hamburg", capacity: "12 000", type: "Convention center" },
      { name: "Koelnmesse", city: "Cologne", capacity: "100 000+", type: "Exhibition center" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "The Caleta Hotel Conference Centre", city: "Gibraltar", capacity: "400", type: "Hotel & Conference" },
      { name: "Rock Hotel Conference Centre", city: "Gibraltar", capacity: "300", type: "Hotel & Conference" },
      { name: "O'Callaghan Eliott Hotel Conference", city: "Gibraltar", capacity: "250", type: "Hotel & Conference" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Jolly Alon Hotel Conference Centre", city: "Chișinău", capacity: "800", type: "Hotel & Conference" },
      { name: "Best Western Plus Flowers Conference", city: "Chișinău", capacity: "600", type: "Hotel & Conference" },
      { name: "National Palace Conference Hall", city: "Chișinău", capacity: "2 000", type: "Convention center" },
    ],
  },
  {
    ...
    topVenues: [
      ...
      { name: "Fairmont Monte Carlo Conference Centre", city: "Monaco", capacity: "1 000", type: "Hotel & Conference" },
      { name: "Hôtel Hermitage Monte-Carlo Conference", city: "Monaco", capacity: "800", type: "Hotel & Conference" },
      { name: "Le Méridien Beach Plaza Conference Centre", city: "Monaco", capacity: "600", type: "Hotel & Conference" },
    ],
  },
  {
